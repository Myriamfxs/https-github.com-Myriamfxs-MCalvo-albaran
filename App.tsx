...
// Base64 encoded logo
const logoSrc = "data:image/png;base64, DRtJUAAAAAAAAAAAAAQDGLAQAAAAAAAAAAAABAqbSVAAAAAAAAAAAAAEDxSwEAAAAAAAAAAADAYGkLAAAAAAAAAAAAAE DRtJUAAAAAAAAAAAAAQDGLAQAAAAAAAAAAAABAqbSVAAAAAAAAAAAAAEDxSwEAAAAAAAAAAADAYGkLAAAAAAAAAAAAAE DRtJUAAAAAAAAAAAAAQDGLAQAAAAAAAAAAAABAqQ2D0wGjxfw2aAAAAABJRU5ErkJggg==";
    ...
    <header className="bg-gray-800 shadow-lg border-b-2 border-gray-700">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-2 flex justify-between items-center">
        <div className="flex items-center space-x-4">
          <img src={logoSrc} alt="Marcelino Calvo Logo" className="h-12" />
...
function App() {
  ...
  if (!isLoggedIn) {
    return <LoginView onLogin={handleLogin} logoSrc={logoSrc} />;
  }
